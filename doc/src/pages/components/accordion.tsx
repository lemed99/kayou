...
export default function AccordionPage() {
  return (
    <DocPage
      title="Accordion"
      description="A vertically stacked set of interactive headings that each reveal or hide an associated section of content. Supports both controlled and uncontrolled modes, smooth expand/collapse animations, and follows WAI-ARIA accordion pattern for full keyboard accessibility."
      props={[
        {
          name: 'panels',
          type: 'PanelData[]',
          default: '[]',
          description: 'Array of panel data objects containing itemKey, title, content, and optional class overrides',
        },
        {
          name: 'highlightedKey',
          type: 'string',
      ...
      examples={[
        {
          title: 'Basic Usage',
          description: 'Simple accordion with default styling. Panels can be opened and closed independently.',
...
<Accordion panels={panels} />`,
        ...
        },
        {
          ...
          description: 'Set isSimple to false for bordered panels with background highlights.',
            ...
            const panels: PanelData[] = [
              {
                ...
                content: <p>Install with npm install solid-js and create your first component.</p>,
              },
              {
                itemKey: 'styled-2',
                title: <span class="font-medium">Core Concepts</span>,
                content: <p>Learn about signals, effects, and memos for reactive programming.</p>,
              },
              {
                itemKey: 'styled-3',
        ...
        },
        {
          ...
          description: 'Manage open/closed state externally for full control over panel behavior.',
...
<Button onClick={() => setOpenPanels('ctrl-2', true)}>
  Open Panel 2
          ...
          component: () => {
            ...
            const panels: PanelData[] = [
              ...
              },
              {
                ...
                content: <p>Click the button below to open this panel programmatically.</p>,
              },
            ];
            return (
        ...
        },
        {
          ...
          description: 'Highlight a specific panel and scroll it into view. Useful for search or navigation.',
...
<Button onClick={() => setHighlighted('panel-3')}>
  Highlight Panel 3
        ...
        },
        {
          ...
          description: 'Each panel can have custom classes for the container, title, and content areas.',
          code: `const panels: PanelData[] = [
  {
    itemKey: 'custom-1',
...
<Accordion panels={panels} isSimple={false} />`,
          component: () => {
            const panels: PanelData[] = [
              {
                itemKey: 'custom-1',
                title: <span class="text-blue-700 dark:text-blue-300">Blue Theme Panel</span>,
              ...
              {
                itemKey: 'custom-2',
                title: <span class="text-green-700 dark:text-green-300">Green Theme Panel</span>,
