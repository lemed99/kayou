...
export default function DatePickerContextPage() {
  return (
    <ContextDocPage
      ...
      usage={`
        import { DatePickerProvider } from '@exowpee/solidly';
      `}
      examples={[
        {
        ...
        },
        {
          ...
          code: `
            import { DatePickerProvider, useDatePicker } from '@exowpee/solidly;
        ...
        },
        {
          ...
          code: `
            // The cache stores 42 days (6 weeks) for each month viewed
        ...
        },
        {
          ...
          code: `
            // The DatePickerProvider is SSR-safe:
        ...
        },
        {
          ...
          code: `
            // Option 1: App-level provider (recommended for most apps)
