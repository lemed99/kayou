...
export default function UseToastPage() {
  return (
    <HookDocPage
      ...
      usage={`import { useToast } from '@exowpee/solidly/hooks';
      ...
      examples={[
        {
          ...
          code: `import { ToastProvider } from '@exowpee/solidly/context';
    ...
    >
      <YourApp />
        ...
        },
        {
          ...
          code: `import { useToast } from '@exowpee/solidly/hooks';
    ...
    <>
      ...
      <Show when={toastId()}>
        ...
        },
        {
          ...
          code: `import type { ToastMethodProps } from '@exowpee/solidly/context';
    ...
    <div class="w-80 overflow-hidden rounded-lg bg-white shadow-lg">
      ...
      <div class="h-1 bg-gray-100">
        ...
        },
        {
          ...
          code: `const UndoToast = (props: ToastMethodProps & { onUndo: () => void }) => (
...
>
  {props.children}
        ...
        },
        {
          ...
          code: `interface ToastMethodProps {
  ...
  <div>
    ...
    <button onClick={props.play}>Resume</button>
        ...
        },
        {
          ...
          code: `// Position options for toast container
type ToastPosition =
  | 'top-left'
  | 'top-center'
  | 'top-right'
...
function BadComponent() {
  ...
  // Throws: "useToast must be used within ToastProvider"
        ...
        },
        {
          ...
          code: `// The ToastContainer automatically renders with:
<div
  role="region"
