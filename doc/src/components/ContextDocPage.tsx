...
export default function ContextDocPage(props: ParentProps<ContextDocPageProps>): JSX.Element {
    ...
    >
      ...
      <Show when={props.usage}>
        <section id="usage" class="mb-8 scroll-mt-20">
          ...
          <p class="mb-4 text-gray-700 dark:text-gray-300">Wrap your application with the provider:</p>
                    ...
                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-800">
                      <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-gray-900 dark:text-white">
                        <span class="flex items-center gap-2">
                          {prop.name}
                          <Show when={prop.required}><span class="text-xs text-red-500">*</span></Show>
                        </span>
                      </td>
                      ...
                      <td class="px-6 py-4 text-xs whitespace-nowrap">
                        <code class="rounded border border-gray-200 bg-gray-50 px-2 py-1 font-mono text-xs text-green-600 dark:border-gray-700 dark:bg-gray-900/50 dark:text-green-400">{prop.default ?? '-'}</code>
                      </td>
                    </tr>
                  )}
                </For>
        ...
        <section id="sub-components" class="mb-8 scroll-mt-20">
          ...
          <Show when={props.contextType}>
            <p class="mb-4 text-gray-700 dark:text-gray-300">
              ...
              <code class="rounded border border-gray-200 bg-gray-50 px-2 py-1 font-mono text-sm text-purple-600 dark:border-gray-700 dark:bg-gray-900/50 dark:text-purple-400">{props.contextType}</code>
            </p>
          </Show>
          <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                <For each={contextValueArray()}>
                  {(value) => (
                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-800">
                      <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-gray-900 dark:text-white">{value.name}</td>
                      <td class="px-6 py-4 text-xs whitespace-nowrap">
                        <code class="rounded border border-gray-200 bg-gray-50 px-2 py-1 font-mono text-xs text-blue-600 dark:border-gray-700 dark:bg-gray-900/50 dark:text-blue-400">{value.type}</code>
                      </td>
                      <td class="min-w-[400px] px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{value.description}</td>
                    </tr>
                  )}
                </For>
              </tbody>
