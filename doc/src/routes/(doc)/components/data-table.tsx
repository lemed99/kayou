...
export default function Example() {
  ...
  const users = [
    { id: 1, name: 'John Doe', email: 'john@example.com', role: 'Admin', status: 'active', age: 32, department: 'Engineering', joinedAt: '2022-03-15', notes: 'Manages social media campaigns and brand partnerships.', contractPeriod: { start: '2022-03-15', end: '2024-03-14' } },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'User', status: 'active', age: 28, department: 'Marketing', joinedAt: '2023-01-10', notes: 'Team lead for the frontend platform.', contractPeriod: { start: '2023-01-10', end: '2024-01-09' } },
    { id: 3, name: 'Bob Johnson', email: 'bob@example.com', role: 'User', status: 'inactive', age: 45, department: 'Sales', joinedAt: '2021-06-22', notes: 'On leave.', contractPeriod: { start: '2021-06-22', end: '2023-06-21' } },
    { id: 4, name: 'Alice Williams', email: 'alice@example.com', role: 'Editor', status: 'active', age: 35, department: 'Engineering', joinedAt: '2022-09-01', notes: 'Responsible for the component library documentation and code reviews.', contractPeriod: { start: '2022-09-01', end: '2024-08-31' } },
    { id: 5, name: 'Charlie Brown', email: 'charlie@example.com', role: 'User', status: 'pending', age: 29, department: 'Support', joinedAt: '2024-11-05', notes: 'Awaiting access approval.', contractPeriod: { start: '2024-11-05', end: '2025-11-04' } },
    { id: 6, name: 'Diana Ross', email: 'diana@example.com', role: 'Admin', status: 'active', age: 41, department: 'HR', joinedAt: '2020-04-18', notes: 'Handles recruitment pipeline and employee relations.', contractPeriod: { start: '2020-04-18', end: '2023-04-17' } },
    { id: 7, name: 'Edward Kim', email: 'edward@example.com', role: 'User', status: 'active', age: 26, department: 'Engineering', joinedAt: '2024-02-14', notes: 'Junior developer.', contractPeriod: { start: '2024-02-14', end: '2025-02-13' } },
    { id: 8, name: 'Fiona Garcia', email: 'fiona@example.com', role: 'Editor', status: 'active', age: 38, department: 'Marketing', joinedAt: '2021-11-30', notes: 'Content strategist overseeing blog posts and whitepapers.', contractPeriod: { start: '2021-11-30', end: '2023-11-29' } },
    { id: 9, name: 'George Chen', email: 'george@example.com', role: 'Admin', status: 'active', age: 50, department: 'Engineering', joinedAt: '2019-08-12', notes: 'VP of Engineering.', contractPeriod: { start: '2019-08-12', end: '2022-08-11' } },
    { id: 10, name: 'Hannah Lee', email: 'hannah@example.com', role: 'User', status: 'inactive', age: 31, department: 'Sales', joinedAt: '2022-05-20', notes: 'Transferred to the London office.', contractPeriod: { start: '2022-05-20', end: '2024-05-19' } },
    { id: 11, name: 'Ivan Petrov', email: 'ivan@example.com', role: 'User', status: 'active', age: 27, department: 'Support', joinedAt: '2023-07-03', notes: 'Tier 2 support specialist handling escalations.', contractPeriod: { start: '2023-07-03', end: '2024-07-02' } },
    { id: 12, name: 'Julia Martinez', email: 'julia@example.com', role: 'Editor', status: 'pending', age: 33, department: 'HR', joinedAt: '2025-01-08', notes: 'New hire.', contractPeriod: { start: '2025-01-08', end: '2026-01-07' } },
    { id: 13, name: 'Kevin O\\'Brien', email: 'kevin@example.com', role: 'User', status: 'active', age: 36, department: 'Engineering', joinedAt: '2021-10-25', notes: 'Backend services and API design.', contractPeriod: { start: '2021-10-25', end: '2023-10-24' } },
    { id: 14, name: 'Laura Nguyen', email: 'laura@example.com', role: 'Admin', status: 'active', age: 44, department: 'Engineering', joinedAt: '2020-01-06', notes: 'Infrastructure and DevOps lead.', contractPeriod: { start: '2020-01-06', end: '2023-01-05' } },
    { id: 15, name: 'Marcus Taylor', email: 'marcus@example.com', role: 'User', status: 'active', age: 23, department: 'Support', joinedAt: '2024-06-17', notes: 'Tier 1 support, night shift.', contractPeriod: { start: '2024-06-17', end: '2025-06-16' } },
    { id: 16, name: 'Nina Patel', email: 'nina@example.com', role: 'Editor', status: 'active', age: 30, department: 'Marketing', joinedAt: '2023-03-28', notes: 'Manages email campaigns and newsletters.', contractPeriod: { start: '2023-03-28', end: '2024-03-27' } },
    { id: 17, name: 'Oscar Fernandez', email: 'oscar@example.com', role: 'User', status: 'inactive', age: 52, department: 'Sales', joinedAt: '2018-12-01', notes: 'Retired from active sales, advisory role.', contractPeriod: { start: '2018-12-01', end: '2021-11-30' } },
    { id: 18, name: 'Patricia Wong', email: 'patricia@example.com', role: 'Admin', status: 'active', age: 39, department: 'HR', joinedAt: '2021-02-14', notes: 'Compensation and benefits specialist.', contractPeriod: { start: '2021-02-14', end: '2023-02-13' } },
    { id: 19, name: 'Quentin Blake', email: 'quentin@example.com', role: 'User', status: 'pending', age: 25, department: 'Engineering', joinedAt: '2025-02-01', notes: 'Intern converting to full-time.', contractPeriod: { start: '2025-02-01', end: '2026-01-31' } },
    { id: 20, name: 'Rachel Adams', email: 'rachel@example.com', role: 'Editor', status: 'active', age: 34, department: 'Marketing', joinedAt: '2022-08-09', notes: 'SEO and analytics lead.', contractPeriod: { start: '2022-08-09', end: '2024-08-08' } },
    { id: 21, name: 'Samuel Green', email: 'samuel@example.com', role: 'User', status: 'active', age: 29, department: 'Engineering', joinedAt: '2023-05-15', notes: 'Mobile development specialist.', contractPeriod: { start: '2023-05-15', end: '2024-05-14' } },
    { id: 22, name: 'Tara Singh', email: 'tara@example.com', role: 'Admin', status: 'active', age: 47, department: 'Engineering', joinedAt: '2019-11-20', notes: 'Security and compliance officer.', contractPeriod: { start: '2019-11-20', end: '2022-11-19' } },
    { id: 23, name: 'Ulrich Braun', email: 'ulrich@example.com', role: 'User', status: 'active', age: 33, department: 'Sales', joinedAt: '2022-07-11', notes: 'EMEA regional account manager.', contractPeriod: { start: '2022-07-11', end: '2023-07-10' } },
    { id: 24, name: 'Valentina Rossi', email: 'valentina@example.com', role: 'Editor', status: 'active', age: 28, department: 'Marketing', joinedAt: '2024-01-22', notes: 'Social media and community management.', contractPeriod: { start: '2024-01-22', end: '2025-01-21' } },
    { id: 25, name: 'William Harris', email: 'william@example.com', role: 'User', status: 'inactive', age: 55, department: 'HR', joinedAt: '2017-09-05', notes: 'On sabbatical.', contractPeriod: { start: '2017-09-05', end: '2022-09-04' } },
    { id: 26, name: 'Xena Cooper', email: 'xena@example.com', role: 'User', status: 'active', age: 31, department: 'Support', joinedAt: '2023-10-30', notes: 'Customer success manager for enterprise clients.', contractPeriod: { start: '2023-10-30', end: '2024-10-29' } },
    { id: 27, name: 'Yusuf Ahmed', email: 'yusuf@example.com', role: 'Admin', status: 'active', age: 42, department: 'Engineering', joinedAt: '2020-06-14', notes: 'Data platform and analytics infrastructure.', contractPeriod: { start: '2020-06-14', end: '2023-06-13' } },
    { id: 28, name: 'Zoe Mitchell', email: 'zoe@example.com', role: 'Editor', status: 'pending', age: 26, department: 'Marketing', joinedAt: '2025-03-01', notes: 'Joining the design content team.', contractPeriod: { start: '2025-03-01', end: '2026-02-28' } },
    { id: 29, name: 'Aaron Phillips', email: 'aaron@example.com', role: 'User', status: 'active', age: 37, department: 'Engineering', joinedAt: '2021-04-07', notes: 'QA automation and testing frameworks.', contractPeriod: { start: '2021-04-07', end: '2023-04-06' } },
    { id: 30, name: 'Bianca Torres', email: 'bianca@example.com', role: 'User', status: 'active', age: 24, department: 'Support', joinedAt: '2024-08-19', notes: 'Bilingual support agent, English and Spanish.', contractPeriod: { start: '2024-08-19', end: '2025-08-18' } },
    { id: 31, name: 'Carlos Rivera', email: 'carlos@example.com', role: 'Admin', status: 'active', age: 46, department: 'Sales', joinedAt: '2019-03-25', notes: 'Head of sales, North America.', contractPeriod: { start: '2019-03-25', end: '2022-03-24' } },
    { id: 32, name: 'Daphne Laurent', email: 'daphne@example.com', role: 'Editor', status: 'active', age: 32, department: 'HR', joinedAt: '2022-12-10', notes: 'Training and onboarding programs.', contractPeriod: { start: '2022-12-10', end: '2023-12-09' } },
    { id: 33, name: 'Ethan Park', email: 'ethan@example.com', role: 'User', status: 'active', age: 27, department: 'Engineering', joinedAt: '2023-09-16', notes: 'Frontend performance optimization.', contractPeriod: { start: '2023-09-16', end: '2024-09-15' } },
    { id: 34, name: 'Freya Johansson', email: 'freya@example.com', role: 'User', status: 'inactive', age: 40, department: 'Marketing', joinedAt: '2020-10-02', notes: 'Moved to partner relations team.', contractPeriod: { start: '2020-10-02', end: '2022-10-01' } },
    { id: 35, name: 'Gabriel Santos', email: 'gabriel@example.com', role: 'Admin', status: 'active', age: 38, department: 'Engineering', joinedAt: '2021-08-23', notes: 'Cloud architecture and cost optimization.', contractPeriod: { start: '2021-08-23', end: '2023-08-22' } },
    { id: 36, name: 'Hana Yamamoto', email: 'hana@example.com', role: 'Editor', status: 'active', age: 29, department: 'Marketing', joinedAt: '2023-02-05', notes: 'Product marketing and launch coordination.', contractPeriod: { start: '2023-02-05', end: '2024-02-04' } },
    { id: 37, name: 'Isaac Cohen', email: 'isaac@example.com', role: 'User', status: 'pending', age: 22, department: 'Support', joinedAt: '2025-04-01', notes: 'New graduate, starting next month.', contractPeriod: { start: '2025-04-01', end: '2026-03-31' } },
    { id: 38, name: 'Jasmine Ali', email: 'jasmine@example.com', role: 'User', status: 'active', age: 35, department: 'Engineering', joinedAt: '2022-01-18', notes: 'Machine learning and recommendation systems.', contractPeriod: { start: '2022-01-18', end: '2024-01-17' } },
    { id: 39, name: 'Kyle Morgan', email: 'kyle@example.com', role: 'Editor', status: 'active', age: 43, department: 'Sales', joinedAt: '2020-07-29', notes: 'Sales enablement content and demo scripts.', contractPeriod: { start: '2020-07-29', end: '2022-07-28' } },
    { id: 40, name: 'Lily Zhang', email: 'lily@example.com', role: 'Admin', status: 'active', age: 36, department: 'HR', joinedAt: '2021-05-11', notes: 'Diversity and inclusion initiatives.', contractPeriod: { start: '2021-05-11', end: '2023-05-10' } },
    { id: 41, name: 'Mason Reed', email: 'mason@example.com', role: 'User', status: 'active', age: 30, department: 'Engineering', joinedAt: '2023-06-20', notes: 'Database administration and query optimization.', contractPeriod: { start: '2023-06-20', end: '2024-06-19' } },
    { id: 42, name: 'Nora Eriksson', email: 'nora@example.com', role: 'User', status: 'active', age: 28, department: 'Marketing', joinedAt: '2024-04-08', notes: 'Event planning and conference logistics.', contractPeriod: { start: '2024-04-08', end: '2025-04-07' } },
    { id: 43, name: 'Oliver Grant', email: 'oliver@example.com', role: 'Editor', status: 'inactive', age: 48, department: 'Engineering', joinedAt: '2018-06-15', notes: 'Transitioned to external consulting.', contractPeriod: { start: '2018-06-15', end: '2021-06-14' } },
    { id: 44, name: 'Priya Sharma', email: 'priya@example.com', role: 'Admin', status: 'active', age: 34, department: 'Support', joinedAt: '2021-12-03', notes: 'Head of customer support operations.', contractPeriod: { start: '2021-12-03', end: '2023-12-02' } },
    { id: 45, name: 'Ryan O\\'Connor', email: 'ryan@example.com', role: 'User', status: 'active', age: 26, department: 'Engineering', joinedAt: '2024-03-12', notes: 'CI/CD pipelines and build tooling.', contractPeriod: { start: '2024-03-12', end: '2025-03-11' } },
    { id: 46, name: 'Sofia Morales', email: 'sofia@example.com', role: 'Editor', status: 'active', age: 31, department: 'Marketing', joinedAt: '2022-11-07', notes: 'Video production and creative direction.', contractPeriod: { start: '2022-11-07', end: '2023-11-06' } },
    { id: 47, name: 'Thomas Weber', email: 'thomas@example.com', role: 'User', status: 'pending', age: 39, department: 'Sales', joinedAt: '2025-01-20', notes: 'Pending background check completion.', contractPeriod: { start: '2025-01-20', end: '2026-01-19' } },
    { id: 48, name: 'Uma Krishnan', email: 'uma@example.com', role: 'User', status: 'active', age: 33, department: 'Engineering', joinedAt: '2022-06-28', notes: 'Accessibility and internationalization specialist.', contractPeriod: { start: '2022-06-28', end: '2024-06-27' } },
    { id: 49, name: 'Victor Dumont', email: 'victor@example.com', role: 'Admin', status: 'active', age: 51, department: 'HR', joinedAt: '2019-05-09', notes: 'Legal compliance and policy oversight.', contractPeriod: { start: '2019-05-09', end: '2022-05-08' } },
    { id: 50, name: 'Wendy Chu', email: 'wendy@example.com', role: 'Editor', status: 'active', age: 27, department: 'Engineering', joinedAt: '2024-09-23', notes: 'Technical writing and API documentation.', contractPeriod: { start: '2024-09-23', end: '2025-09-22' } },
  ];
  ...
  const filterConfigs = [
    ...
    { key: 'joinedAt', label: 'Joined', fieldType: 'datepicker', dataType: 'array', dateConfig: { locale: 'en-US' } },
  ];
