        ...
        },
        {
          ...
          props: [
            ...
            },
            {
              ...
              description: 'Tooltip for underline button.',
            },
            {
              name: 'strikethrough',
              type: 'string',
              default: '"Strikethrough"',
              description: 'Tooltip for strikethrough button.',
            },
            {
              name: 'code',
              type: 'string',
              default: '"Inline Code"',
              description: 'Tooltip for inline code button.',
            },
            {
              name: 'heading1',
              type: 'string',
            ...
            },
            {
              ...
              type: 'string',
              default: '"Heading 4"',
              description: 'Tooltip for heading 4 button.',
            },
            {
              name: 'normalText',
              type: 'string',
              default: '"Normal text"',
              description: 'Tooltip for normal text option.',
            },
            {
              name: 'textStyle',
              type: 'string',
              default: '"Text style"',
              description: 'Tooltip for text style dropdown.',
            },
            {
              name: 'bulletList',
              type: 'string',
            ...
            },
            {
              ...
              type: 'string',
              default: '"Task list"',
              description: 'Tooltip for task list button.',
            },
            {
              name: 'listStyle',
              type: 'string',
              default: '"List style"',
              description: 'Tooltip for list style dropdown.',
            },
            {
              name: 'alignLeft',
              type: 'string',
              default: '"Align Left"',
              description: 'Tooltip for align left button.',
            },
            {
              name: 'alignCenter',
              type: 'string',
              default: '"Align Center"',
              description: 'Tooltip for align center button.',
            },
            {
              name: 'alignRight',
              type: 'string',
              default: '"Align Right"',
              description: 'Tooltip for align right button.',
            },
            {
              name: 'alignJustify',
              type: 'string',
              default: '"Justify"',
              description: 'Tooltip for justify button.',
            },
            {
              name: 'link',
              type: 'string',
            ...
            },
            {
              ...
              type: 'string',
              default: '"Apply link"',
              description: 'Tooltip for apply link button.',
            },
            {
              name: 'openInNewWindow',
              type: 'string',
              default: '"Open in new window"',
              description: 'Tooltip for open in new window toggle.',
            },
            {
              name: 'removeLink',
              type: 'string',
            ...
            },
            {
              ...
              type: 'string',
              default: '"Blockquote"',
              description: 'Tooltip for blockquote button.',
            },
            {
              name: 'codeBlock',
              type: 'string',
              default: '"Code Block"',
              description: 'Tooltip for code block button.',
            },
            {
              name: 'horizontalRule',
              type: 'string',
              default: '"Horizontal Rule"',
              description: 'Tooltip for horizontal rule button.',
            },
            {
              name: 'undo',
              type: 'string',
            ...
            },
            {
              ...
              description: 'Tooltip for clear formatting button.',
            },
            {
              name: 'highlight',
              type: 'string',
              default: '"Highlight"',
              description: 'Tooltip for highlight button.',
            },
            {
              name: 'removeHighlight',
              type: 'string',
              default: '"Remove highlight"',
              description: 'Tooltip for remove highlight button.',
            },
            {
              name: 'superscript',
              type: 'string',
              default: '"Superscript"',
              description: 'Tooltip for superscript button.',
            },
            {
              name: 'subscript',
              type: 'string',
              default: '"Subscript"',
              description: 'Tooltip for subscript button.',
            },
            {
              name: 'imageUpload',
              type: 'string',
              default: '"Add Image"',
              description: 'Tooltip for image upload button.',
            },
            {
              name: 'normal',
              type: 'string',
