        ...
        },
        {
          ...
          component: () => (
            <Popover
              ...
              content={
                <div class="p-3">
                  <p class="text-sm dark:text-neutral-300">Hover to see this content!</p>
                </div>
              }
            >
        ...
        },
        {
          ...
          component: () => (
            <div class="flex items-center gap-4">
              ...
              >
                <span class="rounded border border-dashed border-gray-300 px-3 py-2 text-sm text-gray-500 dark:border-neutral-600 dark:text-neutral-400">
                  Or click here
                </span>
              </Popover>
            ...
            <Popover
              ...
              content={
                <div class="w-48 py-1">
                  <button
                    type="button"
                    class="w-full cursor-pointer px-4 py-2 text-left text-sm hover:bg-gray-100 dark:text-white dark:hover:bg-neutral-700"
                  >
                    Edit
                  </button>
                  <button
                  ...
                  <button
                    type="button"
                    class="w-full cursor-pointer px-4 py-2 text-left text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20"
                  >
                    Delete
                  </button>
                </div>
