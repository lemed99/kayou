    ...
    <DocPage
      ...
      examples={[
        ...
        },
        {
          ...
          description: 'Dark, light, auto (follows theme), or invert (opposite of current theme).',
          component: () => (
            <div class="flex flex-wrap items-center gap-4">
              ...
              <Tooltip content="Auto (follows theme)" theme="auto">
                <Button color="light">Auto</Button>
              </Tooltip>
              <Tooltip content="Invert (opposite theme)" theme="invert">
                <Button color="light">Invert</Button>
              </Tooltip>
            </div>
          ),
        },
