...
const PromoCard = () => (
  <div class="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-neutral-800 dark:bg-neutral-800">
    <div class="mb-2 flex items-center justify-between">
      ...
      <button
        type="button"
        class="cursor-pointer text-gray-400 hover:text-gray-600 dark:hover:text-neutral-300"
      >
    ...
    <p class="text-xs text-wrap text-gray-500 dark:text-neutral-400">
          ...
          component: () => (
            <div class="h-96 overflow-hidden rounded-lg border border-gray-200 bg-white dark:bg-neutral-900">
              <Sidebar
                ...
                pinnedStorageKey="kayou-sidebar-pinned-demo"
              >
                <span class="text-lg font-bold">Dashboard</span>
              </Sidebar>
            </div>
          ...
          component: () => (
            <div class="rounded-lg border border-gray-200 bg-white dark:bg-neutral-900">
              <Sidebar
                ...
                pinnedStorageKey="kayou-sidebar-full-demo"
                pinnedLabel="Pinned"
                footerContent={<PromoCard />}
