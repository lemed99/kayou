  ...
  return (
    <div class="max-w-4xl">
      ...
      <div class="mt-10 grid gap-6 sm:grid-cols-2">
        ...
        <A
          href="/ui/button"
          class="group rounded-xl border border-gray-200 bg-white p-6 transition-all hover:border-blue-500 hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-blue-400"
        >
            ...
            {(comp) => (
              <A
                href={`/ui/${comp
                  ...
                  .replace(/([A-Z])/g, '-$1')
                  .replace(/^-/, '')}`}
                class="rounded-lg bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-700"
              >
                {comp}
              </A>
            )}
