  ...
  return (
    <div class="px-4 pb-24 pt-10 sm:px-6">
      ...
      <div class="mx-auto max-w-4xl text-center">
        ...
        <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <a
            ...
            class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-800"
          >
      ...
      <div class="mx-auto mt-20 max-w-2xl">
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-gray-950 dark:border-neutral-800">
          ...
          <div class="p-4">
            <code class="font-mono text-sm text-gray-100">
              ...
              <span class="text-cyan-400">@kayou/ui</span>
            </code>
          </div>
        </div>
      </div>
      ...
      <div class="mx-auto mt-24 max-w-5xl">
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <For each={features}>
            {(feature) => (
              <div class="rounded-xl border border-gray-200 bg-white p-6 transition-shadow hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <div class="mx-auto mt-24 max-w-5xl">
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <For each={componentCategories}>
            {(category) => (
              <div class="group rounded-xl border border-gray-200 bg-white p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-blue-700">
                <div class="mb-4 inline-flex size-10 items-center justify-center rounded-lg bg-gray-100 text-gray-600 transition-colors group-hover:bg-blue-50 group-hover:text-blue-600 dark:bg-neutral-900 dark:text-neutral-400 dark:group-hover:bg-blue-950 dark:group-hover:text-blue-400">
                  {category.icon}
                </div>
                <h3 class="font-semibold text-gray-950 dark:text-white">
                  {category.name}
                ...
                <div class="mt-4 flex flex-wrap gap-1.5">
                  <For each={category.components.slice(0, 4)}>
                    {(comp) => (
                      <span class="inline-flex rounded bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-600 dark:bg-neutral-900 dark:text-neutral-400">
                        {comp}
                      </span>
                    )}
                  </For>
                  {category.components.length > 4 && (
                    <span class="inline-flex rounded bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-500 dark:bg-neutral-900 dark:text-neutral-500">
        ...
        <div class="mt-10 space-y-6">
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              ...
              <div class="mt-3 overflow-hidden rounded-lg border border-gray-200 bg-gray-950 dark:border-neutral-800">
              ...
              <div class="mt-3 overflow-hidden rounded-lg border border-gray-200 bg-gray-950 dark:border-neutral-800">
                <pre class="overflow-x-auto p-4 text-sm">
                  <code class="font-mono text-gray-100">
                    ...
                    <span class="text-green-400">'@kayou/ui'</span>;{'\n\n'}
      ...
      <div class="mx-auto mt-24 max-w-2xl text-center">
        <div class="rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-50 to-white p-8 dark:border-neutral-800 dark:from-gray-900 dark:to-gray-900">
          ...
          <div class="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-neutral-400 dark:hover:text-white"
            >
              Star on GitHub
              <svg class="size-4" fill="currentColor" viewBox="0 0 24 24">
                <path
