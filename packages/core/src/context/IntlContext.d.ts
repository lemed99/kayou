 ...
 */
export declare const IntlContext: import("solid-js").Context<Accessor<IntlShape<string>> | undefined>;
/**
 ...
 * ```
 */
export declare const IntlProvider: ParentComponent<IntlProviderProps>;
