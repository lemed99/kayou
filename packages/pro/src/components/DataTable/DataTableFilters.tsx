...
import { Button, Popover, Select, TextInput } from '@exowpee/solidly';
import { type Option } from '@exowpee/solidly/helpers';
import {
  FilterFunnel01Icon,
  InfoCircleIcon,
  PlusIcon,
    ...
    <Switch fallback={<span class="text-sm text-gray-500">Unsupported field type</span>}>
      <Match when={props.config.fieldType === 'text'}>
        <TextInput
          ...
          placeholder={props.config.placeholder || 'Enter value...'}
          sizing="sm"
      ...
      >
        <NumberInput
          ...
          placeholder={props.config.placeholder || 'Enter number...'}
          sizing="sm"
          type={props.config.numberConfig?.type || 'integer'}
      ...
      <Match when={props.config.fieldType === 'select'}>
        <Select
          ...
          placeholder={props.config.placeholder || 'Select...'}
          sizing="sm"
          class="min-w-[150px] flex-1"
        />
      </Match>
      ...
      <Match when={props.config.fieldType === 'datepicker'}>
        <DatePicker
          ...
          placeholder={props.config.placeholder || 'Select date...'}
      ...
      <Match when={props.config.fieldType === 'dateRange'}>
        <DatePicker
          ...
          placeholder={props.config.placeholder || 'Select range...'}
          locale={props.config.dateConfig?.locale || 'en'}
    ...
    >
      ...
      <div class="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-700">
        ...
        >
          ...
          {props.addFilterText || 'Add filter'}
        </button>
